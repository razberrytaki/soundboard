  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="pointer-events-none absolute right-3 top-3 px-1 py-1 font-[family-name:var(--font-mono)] text-[0.65rem] uppercase tracking-[0.18em] text-white/72 opacity-0 transition-opacity duration-200 hover:pointer-events-auto hover:opacity-100 focus-visible:pointer-events-auto focus-visible:opacity-100 peer-hover:pointer-events-auto peer-hover:opacity-100 peer-focus-visible:pointer-events-auto peer-focus-visible:opacity-100"
        onClick={() => onEdit(pad)}
        type="button"
      >
        Edit
